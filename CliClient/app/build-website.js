...
<div class="nav-wrapper">
	<div class="nav">
		...
		<div class="nav-right">
			...
			<iframe class="share-btn share-btn-github" src="https://ghbtns.com/github-btn.html?user=wittaya698&repo=joplin-clone&type=star&count=true" frameborder="0" scrolling="0" width="80px" height="20px"></iframe>
		</div>
	</div>
</div>
...
async function main() {
    ...
    renderFileToHtml(
        rootDir + '/README_desktop.md',
        rootDir + '/docs/desktop/index.html',
        {
