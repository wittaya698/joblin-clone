...
//             usage: 'cd <list-title>',
//             description:
//                 'Moved to [list-title] - all further operations will happen within this list. Use `cd ..` to go back one level.',
...
//                 };
//                 NoteFolderService.save('note', note)
//                     .catch(error => {
//                         this.log(error);
//                     })
//                     .then(note => {
