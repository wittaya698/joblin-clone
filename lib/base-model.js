...
class BaseModel {
    ...
    static modOptions(options) {
        ...
        if (!('transactionNextQueries' in options))
    ...
    static async search(options = null) {
        ...
        let params = options.conditionsParams
            ? options.conditionsParams.slice(0)
            : [];
