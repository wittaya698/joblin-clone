...
class Application extends BaseApplication {
    ...
    async generalMiddleware(store, next, action) {
        ...
        if (
            ['EVENT_NOTE_ALARM_FIELD_CHANGE', 'NOTE_DELETE'].indexOf(
                action.type
            ) >= 0
        ) {
        ...
        if (
            ['NOTE_VISIBLE_PANES_TOGGLE', 'NOTE_VISIBLE_PANES_SET'].indexOf(
                action.type
            ) >= 0
        ) {
                ...
                submenu: [
                    ...
                    },
                    {
                        ...
                        click: () => {
                            ...
                            throw new Error(
                                'Import Evernote process need further implementation'
                            );
                            // this.dispatch({
                            //     type: 'NAV_GO',
                            //     routeName: 'Import',
