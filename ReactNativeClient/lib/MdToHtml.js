    ...
    renderTokens_(tokens, options) {
        ...
        for (let i = 0; i < tokens.length; i++) {
            ...
            if (t.type === 'image') {
                ...
                if (t.children) {
                    const parsedChildren = this.renderTokens_(
                        t.children,
                        options
                    );
                ...
                renderedBody = renderedBody.replace(
                    ...
                    function (v, type, index) {
                        const js =
                            ...
                            ':' +
                            index +
                            "'); this.classList.contains('tick') ? this.classList.remove('tick') : this.classList.add('tick'); return false;";
                        return (
                            '<a href="#" onclick="' +
                            js +
                            '" class="checkbox ' +
