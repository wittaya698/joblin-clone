...
class Eloquent {
	...
	public function __construct(array $dbParams, MimeTypes $mimeTypes, Paths $paths, Cache $cache) {
		...
		$this->capsule_->getContainer()->bind(
			"Illuminate\Contracts\Debug\ExceptionHandler",
			"AppBundle\Exception\ExceptionHandler"
		);
